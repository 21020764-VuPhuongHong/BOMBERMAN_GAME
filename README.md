...
## Nhiệm vụ của bạn
- Gói bắt buộc (+8đ)
- <img src="res/done.png" alt="drawing" width="27"/> Thiết kế cây thừa kế cho các đối tượng game +2đ
- <img src="res/done.png" alt="drawing" width="27"/> Xây dựng bản đồ màn chơi từ tệp cấu hình (có mẫu tệp cấu hình, xem [tại đây](https://raw.githubusercontent.com/bqcuong/bomberman-starter/starter-2/res/levels/Level1.txt)) +1đ
- <img src="res/done.png" alt="drawing" width="27"/> Di chuyển Bomber theo sự điều khiển từ người chơi +1đ
- <img src="res/done.png" alt="drawing" width="27"/> Tự động di chuyển các Enemy +1đ
- <img src="res/done.png" alt="drawing" width="27"/> Xử lý va chạm cho các đối tượng Bomber, Enemy, Wall, Brick, Bomb +1đ
- <img src="res/done.png" alt="drawing" width="27"/> Xử lý bom nổ +1đ
- <img src="res/done.png" alt="drawing" width="27"/> Xử lý khi Bomber sử dụng các Item và khi đi vào vị trí Portal +1đ
